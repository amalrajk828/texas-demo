"use client";
/* Kit D — Grey: Team — V5 layout with V2 color tokens */
...
export default function GreyTeam() {
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-[#000000]">
      ...
      <div
        className="absolute -top-48 right-0 w-[500px] h-[500px] rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, color-mix(in srgb, var(--color-brand-red) 4%, transparent), transparent 70%)" }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          <div className="relative pb-10 lg:pb-0 fade-up">
            ...
            >
              <div
                ...
                style={{
                  background: "color-mix(in srgb, var(--color-brand-red) 8%, white)",
                  border: "1px solid color-mix(in srgb, var(--color-brand-red) 16%, transparent)",
                }}
              >
            ...
            <div
              ...
              style={{
                ...
                boxShadow: "0 8px 24px color-mix(in srgb, var(--color-brand-red) 35%, transparent)",
              }}
            >
          ...
          <div className="lg:pl-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-8">
              {HIGHLIGHTS.map((h, i) => {
                ...
                const content = (
                  ...
                  >
                    <span className="text-[10px] font-mono font-bold" style={{ color: "var(--color-brand-red)" }}>
                      {h.prefix}
                    </span>
                    {badge ? (
                      ...
                      <div
                        ...
                        style={{ background: "color-mix(in srgb, var(--color-brand-red) 8%, white)" }}
                      >
                        <Icon className="w-4 h-4" style={{ color: "var(--color-brand-red)" }} strokeWidth={1.8} />
                      </div>
                    )}
            ...
            <div className="fade-up d3">
              <Link
                href="/about-us/"
                className="v2-btn-primary px-7 py-3.5 rounded-full text-[13px] tracking-[0.12em] uppercase font-bold"
              >
