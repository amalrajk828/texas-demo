...
const STATS = [
  { value: "Roof Machines", label: "Equipment Type" },
  { value: "Powered Cradles", label: "Access Systems" },
  { value: "Davit Systems", label: "Installation" },
  { value: "Kuwait & Dubai", label: "Service Locations" },
];

export default function SuspendedAccessHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-1.5 text-[11px] text-white/35 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-white/60">Suspended Access Equipment</span>
          </nav>
        </div>
        <div className="max-w-4xl">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/WINDOW-CLEANING-FACADE-CLEANING-BMU-CRADLE-ROOF-MACHINE-13-1-scaled.jpg" alt="Suspended Access Equipment" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <Building2 className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d1">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
              Supply and Installation of Suspended Access Equipment
            </h1>
          </div>
          <div className="fade-up d2">
            <p className="text-white/55 text-lg leading-relaxed max-w-2xl mb-10">
              Supply and installation of telescopic roof machines, twin track roof machines, powered cradles, recess cradles, monorails, parapet track roof machines, parapet traversing davits, parking davits, and parapet mounted davits for safe building facade access.
            </p>
          </div>
          <div className="fade-up d2">
