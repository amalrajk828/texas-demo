...
import { Cable, ChevronRight, ArrowRight } from "lucide-react";

const STATS = [
  { value: "Design & Detailing", label: "Engineering" },
  { value: "Fabrication", label: "In-House" },
  { value: "Erection", label: "On-Site" },
  { value: "Kuwait & Dubai", label: "Service Locations" },
];

export default function CableSupportsHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-1.5 text-[11px] text-white/35 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-white/60">Cable Steel Structure Supports</span>
          </nav>
        </div>
        <div className="max-w-4xl">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/Structural-Steel-Work.webp" alt="Cable Steel Structure Supports" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <Cable className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d2">
            <p className="text-white/55 text-lg leading-relaxed max-w-2xl mb-10">
              Design, fabrication, and erection of high and low voltage cable support structures, pathways, and steel structural supports — delivering robust electrical infrastructure for industrial facilities.
            </p>
          </div>
          <div className="fade-up d2">
