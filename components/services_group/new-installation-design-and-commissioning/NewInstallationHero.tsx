...
const STATS = [
  { value: "OEM Authorized", label: "Representative" },
  { value: "End-to-End", label: "Design & Commissioning" },
  { value: "P&ID & SLD", label: "Engineering Drawings" },
  { value: "Kuwait & Dubai", label: "Service Locations" },
];

export default function NewInstallationHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-1.5 text-[11px] text-white/35 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-white/60">New Installation Design &amp; Commissioning</span>
          </nav>
        </div>
        <div className="max-w-4xl">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/20220524_110650-scaled.jpg" alt="New Installation Design and Commissioning" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <PenTool className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
              <span className="text-[#e7212b] text-[11px] font-semibold tracking-[2.5px] uppercase">Flow Measurement Solutions</span>
            </div>
          </div>
          <div className="fade-up d1">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
              New Installation Design &amp; Commissioning
            </h1>
          </div>
          <div className="fade-up d2">
            <p className="text-white/55 text-lg leading-relaxed max-w-2xl mb-10">
              Being an authorized OEM Representative, we assist in the specification, design, sizing and operation of future metering systems — from general arrangement and P&amp;ID to electrical SLD, cable schedule, and instrument index.
            </p>
          </div>
          <div className="fade-up d2">
