...
const STATS = [
  { value: "OEM Certified", label: "Training Programs" },
  { value: "On-Demand", label: "Scheduling" },
  { value: "3 Delivery", label: "Methods Available" },
  { value: "Kuwait & Dubai", label: "Service Locations" },
];

export default function AdvancedTrainingHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-1.5 text-[11px] text-white/35 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-white/60">Advanced Training</span>
          </nav>
        </div>
        <div className="max-w-4xl">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/TRAINING.jpg" alt="Advanced Training" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <GraduationCap className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d2">
            <p className="text-white/55 text-lg leading-relaxed max-w-2xl mb-10">
              We regularly offer on-demand training courses in our OEM premises, through videoconferencing, or at customer sites — covering metering installation, commissioning, and operation to ensure your team operates at peak proficiency.
            </p>
          </div>
          <div className="fade-up d2">
