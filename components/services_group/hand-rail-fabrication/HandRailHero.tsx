...
import { GripHorizontal, ChevronRight, ArrowRight } from "lucide-react";

const STATS = [
  { value: "Steel & Aluminum", label: "Materials" },
  { value: "Custom Design", label: "Fabrication" },
  { value: "Safety Compliant", label: "Standards" },
  { value: "Kuwait & Dubai", label: "Service Locations" },
];

export default function HandRailHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-1.5 text-[11px] text-white/35 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-white/60">Hand Rail Fabrication</span>
          </nav>
        </div>
        <div className="max-w-4xl">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/Handrail.jpeg" alt="Hand Rail Fabrication" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <GripHorizontal className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d2">
            <p className="text-white/55 text-lg leading-relaxed max-w-2xl mb-10">
              Skilled creation of safety handrails and support structures using steel, aluminum, and durable materials — fully compliant with safety regulations for industrial and commercial applications.
            </p>
          </div>
          <div className="fade-up d2">
