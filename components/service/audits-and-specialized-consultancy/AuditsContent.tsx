...
import { ArrowRight, CheckCircle2, ClipboardCheck, TrendingUp, ShieldCheck, Settings } from "lucide-react";

const SERVICES = [
  { Icon: ClipboardCheck, title: "Compliance Audits",       body: "Comprehensive audits of your custody metering skid systems to ensure compliance with industry regulations and standards — identifying gaps, minimizing risks, and ensuring precise measurement integrity." },
  { Icon: TrendingUp,     title: "Process Optimization",    body: "Data-driven process optimization strategies tailored to your custody transfer operations. We analyse your workflows and measurement chains to identify efficiency improvements and accuracy enhancements." },
  { Icon: ShieldCheck,    title: "Compliance Assessments",  body: "Independent compliance assessments for your custody metering skid — covering regulatory requirements, industry standards, and internal performance benchmarks to ensure full conformity." },
  { Icon: Settings,       title: "Specialized Consultancy", body: "Expert consultancy tailored to your specific custody metering needs — empowering you with actionable insights, strategic guidance, and proven solutions to optimize your operations." },
];

const CAPABILITIES = [
  "Custody metering skid compliance audits",
  "Measurement uncertainty assessment",
  "Metering system performance benchmarking",
  "API MPMS, AGA, ISO & OIML compliance review",
  "Process optimization recommendations",
  "Metering procedure and documentation review",
  "Independent verification and validation support",
  "Customized consultancy reports and action plans",
];

export default function AuditsContent() {
  return (
    <section className="relative bg-white py-24 lg:py-32 overflow-hidden">
      <div className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full pointer-events-none" style={{ background: "radial-gradient(circle, rgba(231,33,43,0.04) 0%, transparent 70%)" }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="fade-up relative">
            <div className="relative rounded-2xl overflow-hidden aspect-[16/11] bg-[#0B0D26] shadow-2xl shadow-black/15">
              <Image src="/images/services/audits.png" alt="Specialized consultancy audit of oil and gas facility — Texas Technical Services" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
            ...
            <div className="absolute -bottom-5 -right-4 lg:-right-6 bg-gradient-to-br from-[#e7212b] to-[#aa0b1b] rounded-xl px-5 py-3.5 shadow-lg shadow-[#e7212b]/30">
              <p className="text-white text-[10px] font-bold tracking-[1.5px] uppercase leading-none">Data-Driven</p>
              <p className="text-white/75 text-[12px] mt-1 leading-none font-medium">Custody Metering Expertise</p>
            </div>
          </div>
          ...
          <div>
            <div className="fade-up d1">
              ...
              <h2 className="text-3xl sm:text-[2.2rem] font-bold text-[#0B0D26] leading-[1.15] mb-5">Comprehensive Custody Metering Audits &amp; Expert Consultancy</h2>
              <p className="text-gray-500 text-[15px] leading-[1.85] mb-4">We offer comprehensive audits to ensure compliance with industry regulations and standards, minimizing risks and ensuring precise measurements within your custody metering skid system. Our team of expert consultants provides specialized guidance tailored to your specific needs, empowering you with insights and strategies for improved efficiency and accuracy in your custody transfer operations.</p>
              <p className="text-gray-500 text-[15px] leading-[1.85] mb-8">Whether you require audits, process optimization, or compliance assessments for your custody metering skid, we customize our services to enhance your practices — delivering reliable, data-driven solutions that optimize your custody metering operations and guarantee confidence in your measurement accuracy.</p>
            </div>
          ...
          <div className="fade-up d4">
            <div className="mt-8 rounded-2xl bg-[#0B0D26] overflow-hidden relative">
              ...
              <div className="relative z-10 px-8 py-7 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
                <div>
                  <p className="text-white font-bold text-[15px]">Ensure Compliance &amp; Accuracy in Your Custody Metering Operations</p>
                  <p className="text-white/70 text-[13px] mt-0.5">Talk to our experts about your audit and consultancy requirements.</p>
                </div>
