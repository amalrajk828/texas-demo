...
const STATS = [
  { value: "Compliance", label: "Audits & Assessments" },
  { value: "API / ISO", label: "Standards Aligned" },
  { value: "Data-Driven", label: "Process Optimization" },
  { value: "Expert", label: "Consultancy Reports" },
];
    ...
    <section className="relative bg-[#000000] blueprint-grid blueprint-dot-grid overflow-hidden pt-32 pb-16 lg:pb-20 min-h-[400px]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <nav className="flex items-center gap-2 mb-8 text-[14px] text-white/50">
          ...
          <ChevronRight className="w-3.5 h-3.5 text-white/30" />
          <span className="text-white/50">Audits and Specialized Consultancy</span>
        </nav>

        <div className="max-w-full">
          <div className="flex items-center gap-2.5 mb-5">
            <div className="w-8 h-8 rounded-lg bg-[#e7212b]/15 border border-[#e7212b]/25 flex items-center justify-center">
              <ClipboardCheck className="w-4 h-4 text-[#e7212b]" strokeWidth={1.8} />
            </div>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[3.4rem] font-bold text-white leading-[1.08] mb-6">
            Audits &amp;{" "}
            <em className="not-italic text-white">Specialized Consultancy</em>
          </h1>

          <p className="text-white/70 text-[16px] leading-[1.85] mb-10 max-w-none">
            Comprehensive custody metering audits, compliance assessments, and expert consultancy — delivering data-driven insights and strategic guidance to optimize your operations and ensure regulatory conformity across API, AGA, ISO, and OIML standards.
          </p>
