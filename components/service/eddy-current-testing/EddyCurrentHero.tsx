...
const STATS = [
  { value: "ECT", label: "Eddy Current Testing" },
  { value: "Tubes & Surfaces", label: "Inspection Scope" },
  { value: "Non-Contact", label: "Method" },
  { value: "Kuwait & Dubai", label: "Our Locations" },
];

export default function EddyCurrentHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-2 text-[14px] text-white/50 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-white/60">Eddy Current Testing</span>
          </nav>
        </div>
        <div className="max-w-full">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/Eddy-Current-Testing.jpg" alt="Eddy current testing of heat exchanger tubes — TTS Kuwait" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
              Eddy Current{" "}
              <span className="text-white">Testing (ECT)</span>
            </h1>
          </div>
          <div className="fade-up d2">
            <p className="text-white/70 text-lg leading-relaxed max-w-none mb-10">
              Eddy Current Testing is the process of running electronic probes through the length of various types of tubes or along the surfaces of materials to find flaws. An eddy current runs opposite to the current introduced by a probe into a conductive material, revealing defects through impedance changes.
            </p>
          </div>
          <div className="fade-up d2">
