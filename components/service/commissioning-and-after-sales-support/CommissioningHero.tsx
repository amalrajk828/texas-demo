...
const STATS = [
  ...
  { value: "CEMS", label: "Commissioning" },
  { value: "Flow Meters", label: "Metering Skids" },
  { value: "Analyzers", label: "Control Systems" },
];
    ...
    <section className="relative bg-[#000000] blueprint-grid blueprint-dot-grid overflow-hidden pt-32 pb-16 lg:pb-20 min-h-[400px]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <nav className="flex items-center gap-2 mb-8 text-[14px] text-white/50">
          ...
          <ChevronRight className="w-3.5 h-3.5 text-white/30" />
          <span className="text-white/50">Commissioning and After Sales Support</span>
        </nav>
        ...
        <div className="max-w-full">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[3.4rem] font-bold text-white leading-[1.08] mb-6">
            Commissioning &amp;{" "}
            <em className="not-italic text-white">After Sales Support</em>
          </h1>

          <p className="text-white/70 text-[16px] leading-[1.85] mb-10 max-w-none">
            Expert commissioning and 24/7 after-sales support for flow meters, metering control systems, metering skids, analyzers, and CEMS — ensuring seamless integration, peak performance, and minimal downtime throughout your equipment lifecycle.
          </p>
