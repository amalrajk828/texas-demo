...
const STATS = [
  { value: "Water Penetration", label: "Test Type" },
  { value: "Windows / Doors", label: "Test Elements" },
  { value: "Curtain Walls", label: "Facade Systems" },
  { value: "Kuwait & Dubai", label: "Our Locations" },
];

export default function WaterPenetrationHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-2 text-[14px] text-white/50 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-white/60">Water Penetration Test</span>
          </nav>
        </div>
        <div className="max-w-full">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/WATER-PENETRATION-TEST.jpg" alt="Water penetration testing of curtain wall system — Texas Technical Services" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <Droplets className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d2">
            <p className="text-white/70 text-lg leading-relaxed max-w-none mb-10">
              Water penetration testing determines whether leakage is present through windows, doors, and curtain wall systems from the exterior to the interior. The test identifies gaps in weatherproofing and identifies areas where the building envelope is compromised, ensuring facade performance and building envelope integrity.
            </p>
          </div>
          <div className="fade-up d2">
