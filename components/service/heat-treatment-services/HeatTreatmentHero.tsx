...
const STATS = [
  { value: "Low / Mid / High", label: "Temperature Ranges" },
  { value: "Electrical & Fuel", label: "Heating Methods" },
  { value: "PWHT / Annealing", label: "Core Processes" },
  { value: "Kuwait & Dubai", label: "Our Locations" },
];

export default function HeatTreatmentHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-2 text-[14px] text-white/50 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-white/60">Heat Treatment Services</span>
          </nav>
        </div>
        <div className="max-w-full">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/Heat-Treatment-Services.jpeg" alt="Heat treatment of pressure vessel components — TTS Kuwait" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <Flame className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d2">
            <p className="text-white/70 text-lg leading-relaxed max-w-none mb-10">
              Heating services covering low, mid, and high range temperature processes using both electrical and fuel-fired methods. Specialised in on-site heat treatment by oil and gas with high-velocity burners that ensure excellent temperature distribution and uniformity at all times through intense scrubbing action.
            </p>
          </div>
          <div className="fade-up d2">
