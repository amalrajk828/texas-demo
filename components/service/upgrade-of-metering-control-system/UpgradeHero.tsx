...
import { ChevronRight,ArrowRight, ArrowUpCircle } from "lucide-react";
    ...
    <section className="relative bg-[#000000] blueprint-grid blueprint-dot-grid overflow-hidden pt-32 pb-16 lg:pb-20 min-h-[400px]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <ChevronRight className="w-3.5 h-3.5 text-white/30" />
          <span className="text-white/60">Upgrade of Metering Control System</span>
        </nav>
        ...
        <div className="max-w-full">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-[#e7212b]/10 border border-[#e7212b]/25 flex items-center justify-center">
              <ArrowUpCircle className="w-4 h-4 text-[#e7212b]" strokeWidth={1.8} />
            </div>
          ...
          >
            Upgrade of{" "}
            <em className="not-italic text-white">Metering</em>
          ...
          >
            Elevate your industrial operations with our expert Metering Control System Upgradation
            service. At TTS, we specialize in optimizing your existing control systems, ensuring
            they meet the latest industry standards and technological advancements. Seamlessly
            integrating state-of-the-art technologies like Flow Computers, SCADA, PLCs, servers,
            and HMI interfaces — we empower you to make data-driven decisions and streamline your
            workflow.
          </p>
        ...
        >
          {[
            ...
            { num: "Zero",  label: "Disruption Approach" },
            { num: "100%",  label: "Standards Compliance" },
            { num: "EPC",   label: "Turnkey Upgrades" },
          ].map((stat) => (
            <div
              key={stat.label}
