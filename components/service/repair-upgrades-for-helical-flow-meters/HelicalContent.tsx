...
const SERVICES = [
  { Icon: ShieldCheck, title: "Preventive Maintenance", body: "Scheduled preventive maintenance programs to keep your helical flow meters operating at peak accuracy and reliability — reducing the risk of unexpected failures and extending asset life." },
  { Icon: Wrench,      title: "Corrective Maintenance", body: "Rapid corrective maintenance to address meter faults, failures, and performance deviations — restoring your helical flow meters to full operational specification with minimal downtime." },
  { Icon: SearchCode,  title: "Performance & Failure Analysis", body: "In-depth performance analysis and root-cause failure investigations. We identify what went wrong, why it happened, and provide documented findings to prevent recurrence." },
  { Icon: Activity,    title: "Suitable Solutions & Upgrades", body: "Based on our analysis, we recommend and implement the most appropriate repair, upgrade, or replacement solution — tailored to your specific meter model, fluid, and operational requirements." },
];

const CAPABILITIES = [
  "Faure Herman helical flow meter repair & overhaul",
  "Rotor, bearing and seal replacement",
  "Viscosity compensation and K-factor recalibration",
  "On-site and workshop repair options",
  "Performance testing after repair",
  "Failure mode documentation and reporting",
  "Compatibility assessment for upgrade components",
  "Coordination with ILAC/COFRAC calibration facility",
];

export default function HelicalContent() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="fade-up relative">
            <div className="relative rounded-2xl overflow-hidden aspect-[16/11] bg-[#0B0D26] shadow-2xl shadow-black/15">
              <Image src="/images/services/helical-repair.webp" alt="Faure Herman helical flow meter repair and upgrade — TTS Kuwait" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
            ...
            <div className="absolute -bottom-5 -right-4 lg:-right-6 bg-gradient-to-br from-[#e7212b] to-[#aa0b1b] rounded-xl px-5 py-3.5 shadow-lg shadow-[#e7212b]/30">
              <p className="text-white text-[10px] font-bold tracking-[1.5px] uppercase leading-none">Authorised OEM</p>
              <p className="text-white/75 text-[12px] mt-1 leading-none font-medium">Faure Herman Representative</p>
            </div>
          </div>
          ...
          <div>
            <div className="fade-up d1">
              ...
              <h2 className="text-3xl sm:text-[2.2rem] font-bold text-[#0B0D26] leading-[1.15] mb-5">Preventive & Corrective Maintenance for Helical Flow Meters</h2>
              <p className="text-gray-500 text-[15px] leading-[1.85] mb-4">We offer flow meter preventive and corrective maintenance services, performance and failure analysis and provide suitable solutions. As an Authorised Faure Herman OEM Representative, our team has deep expertise in helical flow meter mechanics, performance characteristics, and failure modes.</p>
              <p className="text-gray-500 text-[15px] leading-[1.85] mb-8">Whether your meter requires scheduled servicing, has experienced a performance deviation, or has suffered a mechanical failure — we diagnose, repair, and validate it back to specification.</p>
            </div>
            ...
            <div className="mt-8 rounded-2xl bg-[#0B0D26] overflow-hidden relative">
              ...
              <div className="relative z-10 px-8 py-7 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
                <div className="flex items-center gap-4">
                  <div className="w-11 h-11 rounded-xl bg-[#e7212b]/10 border border-[#e7212b]/20 flex items-center justify-center shrink-0">
                    <Clock className="w-5 h-5 text-[#e7212b]" strokeWidth={1.8} />
                  </div>
                  <div>
                    <p className="text-white font-bold text-[15px]">Minimise Downtime with Expert Helical Meter Maintenance</p>
                    <p className="text-white/70 text-[13px] mt-0.5">Talk to our specialists about your meter model and service requirements.</p>
                  </div>
                </div>
