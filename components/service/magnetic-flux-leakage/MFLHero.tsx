...
import { Magnet, ChevronRight, ArrowRight } from "lucide-react";

const STATS = [
  { value: "MFL", label: "Magnetic Flux Leakage" },
  { value: "Pipelines & Tanks", label: "Primary Applications" },
  { value: "Corrosion & Pitting", label: "Defect Detection" },
  { value: "Kuwait & Dubai", label: "Our Locations" },
];

export default function MFLHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-2 text-[14px] text-white/50 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-white/60">Magnetic Flux Leakage</span>
          </nav>
        </div>
        <div className="max-w-full">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/Magnetic-Flux-Leakage.jpg" alt="Magnetic flux leakage inspection of steel pipeline — TTS Kuwait" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <Magnet className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d1">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
              Magnetic Flux{" "}
              <span className="text-white">Leakage (MFL)</span>
            </h1>
          </div>
          <div className="fade-up d2">
            <p className="text-white/70 text-lg leading-relaxed max-w-none mb-10">
              Magnetic Flux Leakage (MFL) is a magnetic NDT method used to detect corrosion and pitting in steel structures — most commonly pipelines and storage tanks. A powerful magnet magnetises the steel and at areas of corrosion or missing metal, the magnetic field leaks from the steel and is detected by sensors.
            </p>
          </div>
          <div className="fade-up d2">
