...
import { ArrowRight, CheckCircle2, Zap, Thermometer, BarChart3, ShieldCheck } from "lucide-react";

const CARDS = [
  { Icon: Zap,        title: "Charpy Impact Test",    body: "A notched specimen is struck by a swinging pendulum — the energy absorbed in fracturing the specimen indicates its toughness. Widely used for metals in structural and pressure vessel applications." },
  { Icon: BarChart3,  title: "Izod Impact Test",      body: "Similar to Charpy but with the specimen held vertically as a cantilever — commonly used for plastics and non-metallic materials to assess impact energy absorption and fracture behaviour." },
  { Icon: Thermometer, title: "Low Temperature Testing", body: "Impact testing at sub-ambient temperatures to determine ductile-to-brittle transition behaviour — critical for materials used in arctic, cryogenic, or cold service environments." },
  { Icon: ShieldCheck, title: "Industry Applications",  body: "Essential for construction, automotive, aerospace, and oil & gas — where impact resistance determines product safety, reliability, and compliance with material specifications." },
];

const CAPABILITIES = [
  "Charpy V-notch and U-notch impact testing",
  "Izod impact testing for plastics and composites",
  "Low temperature impact testing (sub-ambient)",
  "Ductile-to-brittle transition temperature determination",
  "Lateral expansion and shear fracture measurement",
  "Testing to ASTM E23, ISO 148, BS EN 10045",
  "Absorbed energy (Joules) reporting with full traceability",
  "Certified test reports for structural and pressure vessel compliance",
];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 space-y-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          <div className="fade-up relative">
            <div className="relative rounded-2xl overflow-hidden aspect-[16/11] bg-[#0B0D26] shadow-2xl shadow-black/15">
              <Image src="/images/services/charpy_impact_test.jpg" alt="Charpy impact tester performing toughness test on steel specimen — Texas Technical Services" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
            ...
            <div className="absolute -bottom-5 -right-4 lg:-right-6 bg-gradient-to-br from-[#e7212b] to-[#aa0b1b] rounded-xl px-5 py-3.5 shadow-lg shadow-[#e7212b]/30">
              <p className="text-white text-[10px] font-bold tracking-[1.5px] uppercase leading-none">Charpy / Izod</p>
              <p className="text-white/75 text-[12px] mt-1 leading-none font-medium">Impact Testing</p>
            </div>
          </div>
          <div>
            <div className="fade-up d1">
              ...
              <h2 className="text-3xl sm:text-[2.2rem] font-bold text-[#0B0D26] leading-[1.15] mb-5">Impact Testing for Shock Resistance &amp; Toughness Assessment</h2>
              <p className="text-gray-500 text-[15px] leading-[1.85] mb-4">An impact test is used to observe the mechanics that a material will exhibit when it experiences a shock loading that causes the specimen to immediately deform, fracture or rupture completely.</p>
              <p className="text-gray-500 text-[15px] leading-[1.85] mb-8">Impact testing is a critical mechanical test used to measure a material's resistance to sudden shock and deformation — simulating real-world scenarios where materials are subjected to rapid and forceful impacts. Particularly relevant for construction, automotive, aerospace, and other industries where impact resistance is crucial for product safety and reliability.</p>
            </div>
        ...
        <div>
          <div className="fade-up mb-12">
            ...
            <h2 className="text-3xl sm:text-[2.2rem] font-bold text-[#0B0D26] leading-[1.15]">Impact Testing Methods &amp; Applications</h2>
          </div>
          ...
          <div className="fade-up d4">
            <div className="mt-8 rounded-2xl bg-[#0B0D26] overflow-hidden relative">
              ...
              <div className="relative z-10 px-8 py-7 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
                <div>
                  <p className="text-white font-bold text-[15px]">Need Impact Testing for Your Project?</p>
                  <p className="text-white/70 text-[13px] mt-0.5">Talk to our team about Charpy, Izod, or low-temperature impact testing requirements.</p>
                </div>
