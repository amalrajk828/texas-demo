...
const STATS = [
  { value: "TOFD", label: "Time of Flight Diffraction" },
  { value: "Crack Sizing", label: "Depth Measurement" },
  { value: "Automated", label: "Data Recording" },
  { value: "Kuwait & Dubai", label: "Our Locations" },
];

export default function TOFDHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-2 text-[14px] text-white/50 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-white/60">TOFD</span>
          </nav>
        </div>
        <div className="max-w-full">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/time-of-flight-diffraction-tofd-ultrasonic-testing.jpg" alt="Time of flight diffraction ultrasonic testing of pressure vessel weld — TTS Kuwait" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <Clock className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d1">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
              Time of Flight{" "}
              <span className="text-white">Diffraction (TOFD)</span>
            </h1>
          </div>
          <div className="fade-up d2">
            <p className="text-white/70 text-lg leading-relaxed max-w-none mb-10">
              TOFD uses the time of flight of an ultrasonic pulse to determine the position and size of a reflector. When a crack is present, ultrasonic waves diffract from the crack tip — the measured flight time allows the depth of crack tips to be calculated automatically by simple trigonometry.
            </p>
          </div>
          <div className="fade-up d2">
