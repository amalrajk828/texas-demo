...
export default function CalibrationHero() {
  return (
    <section className="relative bg-[#000000] blueprint-grid blueprint-dot-grid overflow-hidden pt-32 pb-16 lg:pb-20 min-h-[400px]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <ChevronRight className="w-3.5 h-3.5 text-white/30" />
          <span className="text-white/60">Flow Meter Calibration</span>
        </nav>
        ...
        <div className="max-w-full">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-[#e7212b]/10 border border-[#e7212b]/25 flex items-center justify-center">
              <Ruler className="w-4 h-4 text-[#e7212b]" strokeWidth={1.8} />
            </div>
          ...
          >
            Flow Meter{" "}
            <em className="not-italic text-white">Calibration</em>
          </h1>
          ...
          >
            Faure Herman offers calibration services in our world class ILAC/COFRAC ISO 17025
            accredited facility located in France — handling your range of flowmeters and
            providing service available to other brands and competitive metering technologies
            on field-specified viscosity fluids.
          </p>
        ...
        >
          {[
            { num: "ILAC",       label: "Accredited Facility" },
            { num: "COFRAC",     label: "ISO 17025 Certified" },
            { num: "OIML",       label: "R117 Class 0.3" },
            { num: "2 Week",     label: "Emergency Service" },
          ].map((stat) => (
            <div
              key={stat.label}
