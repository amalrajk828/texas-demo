...
import { Network, ChevronRight, ArrowRight } from "lucide-react";

const STATS = [
  { value: "PLC / SCADA", label: "Core Platforms" },
  { value: "Integration", label: "System Connectivity" },
  { value: "Legacy Migration", label: "Brownfield Upgrades" },
  { value: "Kuwait & Dubai", label: "Our Locations" },
];

export default function ControlSystemHero() {
  return (
        ...
        <div className="max-w-full">
          ...
          <div className="fade-up d1">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
              Control System{" "}
              <span className="text-white">Integration &amp; Upgradation</span>
            </h1>
          </div>
          <div className="fade-up d2">
            <p className="text-white/70 text-lg leading-relaxed max-w-none mb-10">
              TTS is your trusted partner for PLC and SCADA-based automation and system integration. Our expertise empowers industries across the spectrum to enhance operational efficiency, improve control, and optimise processes — from legacy system migrations to full greenfield automation builds.
            </p>
          </div>
          <div className="fade-up d2">
