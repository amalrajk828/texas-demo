...
import { Rocket, ChevronRight, ArrowRight } from "lucide-react";

const STATS = [
  { value: "Commissioning", label: "Validation & Testing" },
  { value: "Start-Up", label: "Activation Support" },
  { value: "Maintenance", label: "Ongoing Reliability" },
  { value: "Kuwait & Dubai", label: "Our Locations" },
];

export default function CommissioningHero() {
  return (
        ...
        <div className="max-w-full">
          ...
          <div className="fade-up d1">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
              Commissioning &amp;{" "}
              <span className="text-white">Start-up Support</span>
            </h1>
          </div>
          <div className="fade-up d2">
            <p className="text-white/70 text-lg leading-relaxed max-w-none mb-10">
              From pre-commissioning through hot commissioning, start-up, and post-commissioning handover — TTS guides every stage of your automation project lifecycle. We validate and fine-tune automation systems against predefined specifications, ensure a seamless transition to automated control, and provide maintenance services to sustain peak performance.
            </p>
          </div>
          <div className="fade-up d2">
