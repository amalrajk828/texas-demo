...
const STATS = [
  { value: "Bond Strength", label: "What It Measures" },
  { value: "Concrete & Masonry", label: "Substrate" },
  { value: "Cast-In Inserts", label: "Test Element" },
  { value: "Kuwait & Dubai", label: "Our Locations" },
];

export default function PulloutHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="fade-up">
          <nav className="flex items-center gap-2 text-[14px] text-white/50 tracking-[1.5px] uppercase mb-10 flex-wrap">
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-white/60">Pullout Test</span>
          </nav>
        </div>
        <div className="max-w-full">
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] mb-10 shadow-2xl shadow-black/40">
            <Image src="/images/services/ANCHORS-PULL-TESTING.jpg" alt="Anchor pullout test on concrete substrate — Texas Technical Services Kuwait" fill sizes="100vw" priority quality={80} className="object-cover opacity-60" />
          ...
          <div className="fade-up d1">
            <div className="inline-flex items-center gap-2.5 bg-[#e7212b]/10 border border-[#e7212b]/20 rounded-full px-4 py-2 mb-6">
              <ArrowDown className="w-3.5 h-3.5 text-[#e7212b]" strokeWidth={2} />
          ...
          <div className="fade-up d1">
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] tracking-tight mb-6">
              Pullout Test{" "}
              <span className="text-white">for Bolts &amp; Anchors</span>
            </h1>
          </div>
          <div className="fade-up d2">
            <p className="text-white/70 text-lg leading-relaxed max-w-none mb-10">
              The pullout test determines the strength and integrity of the bond between a bolt and the material in which it is embedded — concrete or masonry. The test measures the force required to pull out a previously cast-in steel insert with an embedded enlarged end, providing critical data for structural anchorage design verification.
            </p>
          </div>
          <div className="fade-up d2">
