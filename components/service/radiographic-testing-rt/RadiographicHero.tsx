...
import { ChevronRight,Radiation } from "lucide-react";

const STATS = [
  { value: "X-Ray", label: "& Gamma Ray" },
  { value: "Internal", label: "Structure Examination" },
  { value: "Welds", label: "Thick Sections & Castings" },
  { value: "ASNT / ISO", label: "Certified Technicians" },
];

export default function RadiographicHero() {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-full">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[3.4rem] font-bold text-white leading-[1.08] mb-6">
            Radiographic{" "}
            <em className="not-italic text-white">Testing (RT)</em>
          </h1>
          <p className="text-white/70 text-[16px] leading-[1.85] mb-10 max-w-none">
            A powerful NDT method using X-rays or gamma rays to examine the internal structure of materials and detect flaws not visible on the surface — particularly useful for inspecting thick sections of materials, welds, castings, and complex structures.
          </p>
